...
//************************************************************************
/*  These credentials can be changed later. */
const char *ssid = "SSID";
const char *password = "Password";
const char* device_token  = "Device Token";
//************************************************************************
int timezone = x * 3600;   // "x" can be changed according to timezone.
int time_dst = 0;
String getData, Link;
String OldCardID = "";
...
void setup() {
  ...
  // these three lines can be deleted if you don't want to get the Adfruit logo appear
  display.display();
